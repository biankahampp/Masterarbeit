...
\begin{figure}[[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{IdentifyAndOutlineRequirements} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{AnforderungenIdentifizieren} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{UseCaseSzenarien} %pdf, jpg, png...
...
\begin{figure}[[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{SystemweiteAnforderungen} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{TestfalleErstellen} %pdf, jpg, png...
...
\begin{center}
  ...
  \caption{Develop Product Documentation-Construction Unterprozess Benutzerdokumentation erstellen}
...
\begin{center}
  ...
  \caption{Develop Product Documentation-Construction Unterprozess Unterstützungsdokumentation erstellen}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\linewidth]{PlanAndManageIterationDec} %pdf, jpg, png...
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\linewidth]{DeployRelease} %pdf, jpg, png...
  \caption{Deploy Release-Transition}
  \label{fig:DeployRelease}
\end{center}
\end{figure}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\linewidth]{IdentifyAndRefineRequirementsDec} %pdf, jpg, png...
  \caption{Identify and refine requirements-Elaboration}
  \label{fig:IndetifyAndRefineRequirementsDec}
\end{center}
\end{figure}

\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\linewidth]{DevelopProductDocumentationDec} %pdf, jpg, png...
  \caption{Develop Product Documentation-Construction}
  \label{fig:DevelopProductDocumentationDec}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{AngebotsVetragswesenVModell} %pdf, jpg, png...
  \caption{Angebots- und Vetragswesen V-Modell}
  \label{fig:AngebotsVetragswesenVModell}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{AngebotErstellenVModell} %pdf, jpg, png...
  \caption{Angebots- und Vetragswesen V-Modell- Unterprozess Angebot erstellen}
  \label{fig:AngebotErstellenVModell}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Vertragabschliessen} %pdf, jpg, png...
  \caption{Angebots- und Vetragswesen V-Modell- Unterprozess Vertrag abschließen}
  \label{fig:Vertragabschliessen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Vertragszusatzabschlieen} %pdf, jpg, png...
  \caption{Angebots- und Vetragswesen V-Modell- Unterprozess Vertragzusatz abschließen}
  \label{fig:Vertragszusatzabschlieen}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Lieferungerstellen} %pdf, jpg, png...
  \caption{Angebots- und Vetragswesen V-Modell- Unterprozess Lieferung erstellen}
  \label{fig:Lieferungerstellen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{PlanungUndSteuerung} %pdf, jpg, png...
  \caption{Planung und Steuerung}
  \label{fig:PlanungUndSteuerung}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{ProjektfortschrittsEntscheidung} %pdf, jpg, png...
  \caption{Planung und Steuerung - Unterprozess Projektfortschrittsentscheidung herbeiführen}
  \label{fig:ProjektFortschrittsentscheidung}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{ProjekthandbuchErstellen} %pdf, jpg, png...
  \caption{Planung und Steuerung - Unterprozess Projekthandbuch erstellen}
  \label{fig:ProjekthandbuchErstellen}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{QSHandbuch} %pdf, jpg, png...
  \caption{Planung und Steuerung - Unterprozess QS-Handbuch erstellen}
  \label{fig:QSHandbuch}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Schatzungdurchfuhren} %pdf, jpg, png...
  \caption{Planung und Steuerung - Schätzung durchführen}
  \label{fig:Schatzungdurchfuhren}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{RisikenManagen} %pdf, jpg, png...
  \caption{Planung und Steuerung - Risiken managen}
  \label{fig:RisikenManagen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{ProjektPlanen} %pdf, jpg, png...
  \caption{Planung und Steuerung - Projekt planen}
  \label{fig:ProjektPlanen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Systementwurf} %pdf, jpg, png...
  \caption{Systementwurf-imperativ}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{SystemarchitekturErstellen} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Unterprozess Systemarchitektur erstellen}
  \label{fig:SystemarchitekturErstellen}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{UnterstutzungsSystemarchitektur} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Unterprozess Unterstutzungssystemarchitektur erstellen}
  \label{fig:SystemarchitekturErstellen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Styleguide} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Unterprozess Styleguide fur die Mensch-Maschine-Schnittstelle erstellen}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{HW-Architekturerstellen} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Unterprozess HW-Architektur erstellen}
  \label{fig:HW-Architekturerstellen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{SW-Architekturerstellen} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Unterprozess SW-Architektur erstellen}
  \label{fig:SW-Architekturerstellen}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Datenbankentwurferstellen} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Datenbankentwurf erstellen}
  \label{fig:Datenbankentwurferstellen}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Implementierungs} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Implementierungs-, Integrations- und Prufkonzept System erstellen}
  \label{fig:Implementierungs-, Integrations- und Prufkonzept System erstellen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Integrations} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Implementierungs-, Integrations- und Prufkonzept Unterstutzungssystem erstellen}
  \label{fig:Implementierungs-, Integrations- und Prufkonzept Unterstutzungssystem erstellen}
\end{center}
\end{figure}

\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Prufkonzept} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Implementierungs-, Integrations- und Prufkonzept SW erstellen}
  \label{fig:Implementierungs-, Integrations- und Prufkonzept SW erstellen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Migrationskonzepterstellen} %pdf, jpg, png...
  \caption{Systementwurf-imperativ-Migrationskonzept erstellen}
  \label{fig:Migrationskonzepterstellen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Berichtswesen} %pdf, jpg, png...
  \caption{Berichtswesemn-imperativ}
  \label{fig:ProjektPlanen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Projektstatusbericht} %pdf, jpg, png...
  \caption{Berichtswesemn-imperativ-Unterprozess Projektstatusbericht erstellen}
  \label{fig:Projektstatusbericht}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Besprechung} %pdf, jpg, png...
  \caption{Berichtswesemn-imperativ-Unterprozess Besprechung durchführen}
  \label{fig:Besprechung}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Angebotswesen} %pdf, jpg, png...
  \caption{Angebots- und Vertragswesen - deklarativ}
  \label{fig:Angebotswesen}
\end{center}
\end{figure}
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{Planung} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\linewidth]{BerichtswesenDec} %pdf, jpg, png...
