...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{TabelleScrum} %pdf, jpg, png...
...
\begin{sidewaysfigure}[htp]
\begin{center}
  \includegraphics[width=\textwidth,height=3cm]{OpenUpPhasen} %pdf, jpg, png...
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{TransitionDecUnter} %pdf, jpg, png...
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\linewidth]{Develop} %pdf, jpg, png...
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{DeployReleaseDecKlein} %pdf, jpg, png...
  \caption{Release deployen-Transition}
...
Die Abläufe der Diagramme wurden in Signavio und Declare getestet, wodurch ihre \textit{Vergleichbarkeit} garantiert ist [A 6.1].\newline
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{TabelleOpenUP} %pdf, jpg, png...
...
Bei der nächsten Aktivität wird der \grqq Projektstatusbericht erstellt\grqq \ , wobei das Artefakt \grqq Projektstatusbericht\grqq \ erstellt wird. Danach wird der \grqq Gesamtprojektfortschritt ermittelt\grqq.
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\textwidth, height=8cm]{SystemV} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\textwidth, height=12cm]{SystementwurfKleinDec} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\textwidth, height=10cm]{BerichtswesenKlein} %pdf, jpg, png...
...
\begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\textwidth]{TabelleVModell} %pdf, jpg, png...
...
Abbildung \ref{fig:TabelleAllgemein} gibt nochmals eine zusammenfassende Übersicht über die Ergebnisse des Vergleichs. 



 \begin{figure}[!htbp]
\begin{center}
  \includegraphics[width=\textwidth]{TabelleAllgemein} %pdf, jpg, png...
