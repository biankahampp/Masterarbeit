...
\end{figure}
\subsection{Vergleich}
Abbildung \ref{fig:DeployRelease} zeigt die deklarative Modellierung von Deploy Release.\newline
...
In Abbildung \ref{fig:IndetifyAndRefineRequirementsDec} ist die deklarative Modellierung von Identify and Refine Requirements dargestellt.\newline
...
Abbildung \ref{fig:IndetifyAndRefineRequirementsDec} zeigt die deklarative Modellierung von Develop product Documentation.\newline
