...
Die Aktivitäten \textit{alle 24 Stunden 15-minütiges Scrum-Meeting durchführen} und Tasks abarbeiten können während des Sprints so oft wie nötig durchgeführt werden.
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\linewidth]{PlanIterationKlein} %pdf, jpg, png...
  \caption{Plan and manage iteration deklarativ}
  \label{fig:PlanIterationKlein}
\end{center}
\end{figure}
\subsection{Vergleich}
