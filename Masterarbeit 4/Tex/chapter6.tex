...
\begin{sidewaysfigure}[htp]
\begin{center}
  \includegraphics[scale=0.7]{AngebotsVetragswesenVModell} %pdf, jpg, png...
...
\begin{sidewaysfigure}[htp]
\begin{center}
  \includegraphics[scale=0.7]{AngebotErstellenVModell} %pdf, jpg, png...
...
\begin{sidewaysfigure}[htp]
\begin{center}
  \includegraphics[scale=0.7]{Vertragabschliessen} %pdf, jpg, png...
...
\begin{sidewaysfigure}[htp]
\begin{center}
  \includegraphics[scale=0.7]{Vertragszusatzabschlieen} %pdf, jpg, png...
...
\begin{sidewaysfigure}[htp]
\begin{center}
  \includegraphics[scale=0.7]{Lieferungerstellen} %pdf, jpg, png...
